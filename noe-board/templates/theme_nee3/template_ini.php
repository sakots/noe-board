<?php
//--------------------------------------------------
//　「noe-board」v0.16.0～用テーマ「nee3」設定ファイル
...
//メインのテンプレートファイル
define('MAINFILE', "nee3_main.html");

//レスのテンプレートファイル
define('RESFILE', "nee3_res.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "nee3_paint.html");

//動画再生のテンプレートファイル
define('ANIMEFILE', "nee3_anime.html");
...
//その他のテンプレートファイル
define('OTHERFILE', "nee3_other.html");
