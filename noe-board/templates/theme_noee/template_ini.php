<?php
//--------------------------------------------------
//　「noe-board」v0.13.2～用スキン「noee」設定ファイル
...
//メインのテンプレートファイル
define('MAINFILE', "noee_main.html");

//レスのテンプレートファイル
define('RESFILE', "noee_res.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "noee_paint.html");

//動画再生のテンプレートファイル
define('ANIMEFILE', "noee_anime.html");

//投稿時のテンプレートファイル
define('PICFILE', "noee_picpost.html");

//管理モードのテンプレートファイル
define('ADMINFILE', "noee_admin.html");

//その他のテンプレートファイル
define('OTHERFILE', "noee_other.html");
